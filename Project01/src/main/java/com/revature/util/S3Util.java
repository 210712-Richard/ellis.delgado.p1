...
public class S3Util {
	...
	public static final String BUCKET_NAME = "ellisp1bucket";
	...
	public void uploadToBucket(String key, byte[] file) {
		...
		s3.putObject(PutObjectRequest.builder()
			.bucket(BUCKET_NAME).key(key).build(), RequestBody.fromBytes(file));
		log.trace("Upload complete");
	}
	public InputStream getObject(String key) {
		log.trace("Retrieving data from s3: "+ key);
		InputStream object = s3.getObject(GetObjectRequest.builder()
